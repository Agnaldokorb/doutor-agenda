            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>
                    • Fotos de perfil (quando fornecidas voluntariamente).
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-700">
                  Todos os terceiros seguem padrões de segurança compatíveis com
                  a LGPD.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-700">
                  Caso seus dados sejam processados fora do Brasil, garantimos
                  que o tratamento seguirá os requisitos da LGPD, incluindo
                  cláusulas contratuais adequadas e países com grau de proteção
                  equivalente.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-700">
                  ...
                  desempenho e a personalização da plataforma. Você pode
                  gerenciar suas preferências de cookies no painel de
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-700">
                  ...
                  lei. Dados médicos são mantidos conforme determinações do
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-700">
                  ...
                  Notificaremos sobre mudanças significativas através dos canais
